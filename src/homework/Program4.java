...
public static void main(String[] args) {
        ...
        // Static method can call directly inside main method
        isLeapYear(-1600);
        isLeapYear(1600);
        isLeapYear(2017);
        isLeapYear(2000);
...
public static boolean isLeapYear(int year) // with return type with one parameter method
    {
        ...
        if (year < 1 || year > 9999)
        {
            b = false;
            System.out.print(b);
            System.out.println(" " + year + " is not within parameter range(1-9999)");
        }
...
public static int getDaysInMonth(int month, int year)  // with return type with two parameter method
        {
